...
In addition to this initial selection of variables, we are only going to be looking at verified data by using sanctioned and tested data hence a filtering is applied and these variables removed.
